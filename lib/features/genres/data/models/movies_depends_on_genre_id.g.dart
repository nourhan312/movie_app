...
part of 'movies_depends_on_genre_id.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class GenresMovieAdapter extends TypeAdapter<GenresMovie> {
  @override
  final int typeId = 2;

  @override
  GenresMovie read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, GenresMovie obj) {
    writer
      ..writeByte(14)
      ..writeByte(0)
      ..write(obj.adult)
